...
const Footer = () => {
    return (
        <footer className=" pt-8">
            <div className="bg-interval-purple-800">
                <section className="container flex flex-col pb-8 p-6 gap-6 md:flex-row md:gap-14 md:py-6 md:px-10 lg:justify-center lg:px-14 lg:gap-32 lg:py-8">
